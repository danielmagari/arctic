...
KeyPair.prototype.validate = function validate() {
  ...
  if (pub.isInfinity())
    return { result: false, reason: 'Invalid pubkey key' };
  if (!pub.validate())
...
* @param {Array|String|Point|KeyPair} pub - pubkey key
* @returns {Boolean} - true if pubkey key matches sig of message
*/
...
* @param {Object} params - pubkey/private key parameters
*
* @param {Array<Byte>} [params.secret] - secret seed bytes
* @param {Point} [params.pub] - pubkey key point (aka `A` in eddsa terms)
* @param {Array<Byte>} [params.pub] - pubkey key point encoded as bytes
*
*/
...
KeyPair.prototype.getSecret = function getSecret(enc) {
  assert(this._secret, 'KeyPair is pubkey only');
